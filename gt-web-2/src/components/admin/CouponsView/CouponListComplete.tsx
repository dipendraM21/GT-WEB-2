...
import {
  CommonFormElement,
  DeleteRecordModal,
} from "../../commonCrud/CommonElement/CommonFormElement";
...
const couponCrudApi = createCommonCrud({
  apiName: "coupons",
  apiUrl: `${process.env.NEXT_PUBLIC_CORE_API_URL}coupons`,
  ...
  crudApi: {
    formCrud: {
      action_alias: "coupon",
      create: `${process.env.NEXT_PUBLIC_CORE_API_URL}coupons/add-coupon`,
      update: `${process.env.NEXT_PUBLIC_CORE_API_URL}coupons/update-coupon`,
    },
    tableCrud: {
      action_alias: "coupons",
      get: `${process.env.NEXT_PUBLIC_CORE_API_URL}coupons/get-coupons`,
    },
  },
});

export default function CouponListComplete() {
  ...
  // Define columns for TanStack Table with proper typing
  const couponColumns = [
    {
      accessorKey: "_id",
      header: "CouponId",
  ...
  return (
    ...
    >
      ...
      {/* Form Modal */}
      <CommonFormElement form={CouponForm} apiName="coupons" />

      {/* Delete Confirmation Modal */}
      <DeleteRecordModal apiName="coupons" />
    </AdminCard>
  );
}
