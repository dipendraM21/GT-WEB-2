'use client'
import FormSectionTitle, { AdminCard } from '@/components/core/Card/AdminCard'
...
import TimeInputField from '@/components/core/TimePicker/TimeInputField'
...
import { labelValueProps } from '@/types/module/core/selectInputFieldModule'
      ...
      if (field.type === FieldType.SELECT_INPUT_FIELD) {
        return (
          <SelectInputField
            ...
            name={field.name}
            options={
              field.options as Array<{ value: string; label: string } | string>
            }
